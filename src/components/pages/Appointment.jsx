      ...
      return docInfo && (
            <div className="p-4 sm:p-6 md:p-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <div className="flex-1 border border-gray-400 rounded-lg p-4 sm:p-6 md:p-8 bg-white mx-2 sm:mx-0 mt-4 sm:mt-0">
                              ...
                              <div>
                                    ...
                                    <p className="text-sm text-gray-500 max-w-full sm:max-w-[700px] mt-1">{docInfo.about}</p>
                              </div>
